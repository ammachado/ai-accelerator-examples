...
EXPECTED_REPO=${EXPECTED_REPO:-"https://github.com/ammachado/ai-accelerator-examples.git"}
EXPECTED_BRANCH=${EXPECTED_BRANCH:-"maas"}
...
main() {
  APP_PATCH_FILE="./examples/models-as-a-service/argocd/base/applicationset.yaml"
  APP_PATCH_PATH=".spec.source.targetRevision"
